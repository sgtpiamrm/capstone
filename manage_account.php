<?php
// Query to fetch the user's information (student details, department, and curriculum)
...
// Loop through the result to assign values to variables
foreach ($user->fetch_array() as $k => $v) {
    $$k = $v;
}
?>
<style>
    /* Styling for student image */
    .student-img {
...
<div class="content py-4">
    <div class="card card-outline card-primary shadow rounded-0">
        <div class="card-header rounded-0">
            <h5 class="card-title">Update Details</h5> <!-- Title for the update section -->
        </div>
...
<script>
    ...
    // jQuery document ready function for form submission
    $(function () {
        $('#update-form').submit(function (e) {
            ...
            // AJAX request to save the updated student data
            $.ajax({
